...
const contract = new ethers.Contract(SimulatorV1Address, SimulatorV1ABI, signer)
...
;(async () => {
  ...
  const swapParam2 = {
    protocol: 1,
    pool: '0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174', // USDC POS polygon
    tokenIn: '0xc2132D05D31c914a87C6611C10748AEb04B58e8F', // Tether POS Polygon
  ...
  const swapParam3 = {
    protocol: 2,
    pool: '0x445FE580eF8d70FF569aB36e80c647af338db351', // Curve.fi pool address
    tokenIn: '0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174', // USDC POS polygon
    tokenOut: '0xc2132D05D31c914a87C6611C10748AEb04B58e8F', // Tether POS Polygon
    fee: 0,
    amount: 0,
  }
